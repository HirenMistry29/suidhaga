...
const Login = () => {
  ...
  async function handleSubmit(){
    const loginData = {username : 'HM' , password : password}
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white sm:p-[3%] xs:max-sm:py-[8%] xs:max-sm:px-[4%]  shadow-2xl w-[70%] h-[60%]">
                  ...
                  <div className=" mt-[4%]">
                      <div className="flex justify-center">
                          <div id='send_otp_button' className='px-[20%] py-[1%] bg-[#C84869] text-white mt-[2%] rounded-md cursor-pointer' onClick={handleSubmit}>Login</div>
                      </div>
                  </div>
              </form>
              </div>
