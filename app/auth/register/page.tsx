          ...
          <div id='card' className=' w-screen h-screen'>
              ...
              <div className={`${!status && 'hidden'} `}>
                    <div className={`${SansitaBold.className} text-md text-[#333333] md:text-xl mt-[2%] w-[100%] flex xs:max-md:place-content-center `}>Create Your Password</div>
                        <div className='mt-[2%] w-full'><PasswordForm password={setPassword} status={setStatus}/></div>
              </div>
              <div className={`${!password&&'hidden'}`}>
                <div className={`${SansitaBold.className} text-md text-[#333333] md:text-xl mt-[2%] w-[100%] flex xs:max-md:place-content-center `}>User Details</div>
