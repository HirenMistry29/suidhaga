    ...
    >
      <div className='px-2 py-2 mx-auto flex flex-row'>
        <div className='lg:w-4/5 mx-auto flex flex-col'>
          <Image
            alt='ecommerce'
            className='lg:w-full w-full lg:h-auto h-64 object-cover object-center rounded-xl'
            src={NewImage}
          />
          </div>
          <div>
          <div className='lg:w-full w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0 p-4'>
            ...
            <div className='flex flex-col'>
              ...
              <LikeOutlined className='text-3xl px-2'></LikeOutlined>
              <CommentOutlined className='text-3xl px-2'></CommentOutlined>
              </div>
              <button className=' ml-2 w-full text-black bg-[#C84869] border-2 py-2 px-6 focus:outline-none hover:bg-[#A72447] rounded'>
                Buy
              </button>
